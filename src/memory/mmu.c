...
static uint64_t kcode_end = 0x43000000;
...
void mmu_init() {
    ...
    for (uint64_t addr = UART_BASE; addr <= UART_BASE + 0x1000; addr += GRANULE_4KB) mmu_map_4kb(addr, addr, MAIR_IDX_DEVICE, 1);
